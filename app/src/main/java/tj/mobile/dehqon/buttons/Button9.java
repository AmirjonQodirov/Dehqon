...
public class Button9 extends AppCompatActivity {
    ...
    public void fill_btn_9(View view) throws InterruptedException {
        ...
        row5 = findViewById(R.id.btn9_input_5);
        row6 = findViewById(R.id.btn9_input_6);
        row7 = findViewById(R.id.btn9_input_7);
        ...
        if (r1.length() > 0 && r2.length() > 0 && r3.length() > 0 && r4.length() > 0 && r5.length() > 0
            ...
            contentValues.put(DBHelper.TABLE_9_row5, r5);
            contentValues.put(DBHelper.TABLE_9_row6, r6);
            contentValues.put(DBHelper.TABLE_9_row7, r7);
